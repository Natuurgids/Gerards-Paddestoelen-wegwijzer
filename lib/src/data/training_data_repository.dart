...
class TrainingDataRepository {
  ...
  Future<void> saveScore(int lessonId, double score) async {
    final currentSession =
        _sessionProgress[lessonId] ?? (bestScore: 0.0, attempts: 0);
    _sessionProgress[lessonId] = (
      bestScore: score > currentSession.bestScore ? score : currentSession.bestScore,
    ...
    try {
      ...
      // The score remains available for this session through _sessionProgress.
    }
  }
}
